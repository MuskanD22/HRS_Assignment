...
#print(bookings.printSchema())
 #Create two new columns in the filtered DataFrame, arrival_date and departure_date
#filtered_bookings = filtered_bookings.withColumn("arrival_date", concat_ws("-", col("arrival_date_year"), col("arrival_date_month"), col("arrival_date_day_of_month"))) \
 #                                     .withColumn("departure_date", date_add(col("arrival_date"), col("stays_in_weekend_nights") + col("stays_in_week_nights")))
...
filtered_bookings = filtered_bookings.withColumn("arrival_date", concat_ws("-", col("arrival_date_year"), col("arrival_date_month"), col("arrival_date_day_of_month"))) \
                                     .withColumn("departure_date", expr("date_add(arrival_date, CAST(stays_in_weekend_nights AS INT) + CAST(stays_in_week_nights AS INT))"))
                                                 ...
                                                 #date_add(col("arrival_date"), (col("stays_in_weekend_nights") + col("stays_in_week_nights")).cast("int")))
...
#filtered_bookings.write.csv("C:/Users/mohit/Desktop/HRS/output/filtered_bookings.csv")
#filtered_bookings.to_parquet("C:/Users/mohit/Desktop/HRS/output/filtered_bookings.parquet")
